...
with open('/opt/sapply-klm/server/src/routes/upload.ts', 'r', encoding='utf-16') as f:
    content = f.read()
...
# Write back with utf-16 encoding
with open('/opt/sapply-klm/server/src/routes/upload.ts', 'w', encoding='utf-16') as f:
    f.write(content)
