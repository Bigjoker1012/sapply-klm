...
// ============================================================================
// 5c. Планирование закупок (страница «Планирование закупок»)
// ============================================================================
...
export const purchasePlanSetting = pgTable("purchase_plan_setting", {
  ...
  /** Среднемесячный расход, введённый вручную (кг/мес); null = не задан */
  manualAvgUsage: doublePrecision("manual_avg_usage"),
  /** Момент последнего изменения (ISO UTC) */
